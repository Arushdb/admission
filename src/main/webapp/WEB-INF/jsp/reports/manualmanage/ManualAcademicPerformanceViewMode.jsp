<%@ page language="java" import="java.util.*, in.ac.dei.edrp.admissionsystem.common.beans.Applicant" pageEncoding="ISO-8859-1" isELIgnored="false"%>
...
<br/>
IF YOU WANT TO CHANGE YOUR ACADEMIC DETAILS THEN CLICK <a href="<%=response.encodeURL(request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/manualmanage/getEditScreen.htm?applicationNumber="+((Applicant)request.getAttribute("applicant")).getApplicationNumber())%>" style="font-weight: bold;">Change My Academic Details</a></label>
