...
<a href="../report/logoutCertificatePreference.htm" style="font-weight: bold;">Logout <i class="fa fa-power-off" style="font-size:36px;color:green"></i></a>
</div>

  <form method="post" action="../report/submitPreference.htm"> 
  <div class="card">
	...
	<c:if test="${not empty sessionScope.applicant.programs}">
	<tr>
	<td style="text-align:right">Transfer from Program</td>
	<td align="left">
	<adm:select class="cwFields" name="transferFromProgram" id="transferFromProgram" optionList="${sessionScope.applicant.programs}" defaultText="-Select From Program-"/>
  	</td>
	</tr>
	</c:if>
	<tr>
	...
	<td align="left">
	<adm:select class="cwFields" name="p1" id="p1" optionList="${preferencePrograms}" defaultText="-Select Preferred Program-"/>
	</td>
	</tr>
	<tr>
	<td style="text-align:right">Preference 2</td>
	<td align="left">
	<adm:select class="cwFields" name="p2" id="p2" optionList="${preferencePrograms}" defaultText="-Select Preferred Program-"/>
	</td>
	</tr>
	<tr>
	<td style="text-align:right">Preference 3</td>
	<td align="left">
	<adm:select class="cwFields" name="p3" id="p3" optionList="${preferencePrograms}" defaultText="-Select Preferred Program-"/>
	</td>
	</tr>
