...
<body>
<form method="post" action="../report/getUploadDocumentsPanelLE.htm">
<div class="container" style="margin-top:40px">
<center><h3 style="color:green">Upload Certificates for Lateral Entry</h3></center></br>
  ...
  <div class="card">
    <div class="card-header bg-info" style="font-weight: bold;color:white;">Login for documents upload (Lateral Entry)</div>
    <div class="card-body">
	<table cellpadding="5" cellspacing="5" width="80%">
	<tr>
	<td style="text-align:right">Roll Number</td><td><input class="form-control" name="applicationNumber"/></td>
	</tr>
	<tr>
