...
<div class="panelContent" align="center" style="padding-left: 20px;padding-right: 20px;">
	...
	<form method="post" action="../account/createAccount.htm" onsubmit="return valid();" id="accountForm">
...
<tr>
    		<td>Alternate-Email ID</td><td align="left"><input type="text" name="altEmailID" id="altEmailID" onkeyup="changeStyle(this)" value="${requestScope.applicant.secondaryEmailID}" maxlength="100" autocomplete="off"/></td>
    		</tr>
    		    		
<tr>
    		<td>Date of Birth</td><td align="left"><adm:date class="dateField" name="dd" id="dd" size="1" defaultText="-Date-" startIndex="1" endIndex="31" onchange="changeStyle(this);"/>-<adm:date class="dateField" name="mm" id="mm" size="1" defaultText="-Month-" startIndex="1" endIndex="12"  onchange="changeStyle(this);"/>-<adm:date class="dateField" name="yyyy" id="yyyy" size="1" defaultText="-Year-" startIndex="1900" endIndex="2015"  onchange="changeStyle(this);"/></td>
    		</tr>
    		<tr>
    		<td>Category</td>
    						<td align="left">
    		...
    		<td>Gender</td><td align="left"><input type="radio" name="gender" value="M"/>Male<input type="radio" name="gender" value="F"/>Female</td>
   	 		...
   	 		<tr>
    		<td>Aadhar Number</td><td align="left"><input type="text" name="aadharNumber" id="aadharNumber" maxlength="12" value="${requestScope.applicant.aadharNumber}" autocomplete="off"/></td>
   	 		</tr>
   			<tr>
    		<td>Country</td><td align="left"><select class="cwFields" id="country" name="country" onchange="changeStyle(this); handleStateCB();"><option value="">-Select Country-</option></select></td>
     		...
     		<tr>
    		<td>Contact Number (10 Digits)</td><td align="left"><input type="number" name="phoneNo" maxlength="10"  id="phoneNo" onkeyup="changeStyle(this)" value="${requestScope.applicant.homePhone}" autocomplete="off"/></td>
    		</tr>
    		<tr>
    		<td>Alternate-Contact Number (10 Digits)</td><td align="left"><input type="number" name="altPhoneNo" maxlength="10"  id="altPhoneNo" onkeyup="changeStyle(this)" value="${requestScope.applicant.otherPhone}" autocomplete="off"/></td>
    		</tr>
   			<tr>
    		...
    		<tr>
    			<td colspan="2" align="center"><img id="capimg" src="../SimpleCaptcha.jpg"/><br/>
...
<script src="../jsFiles/Properties.js"></script>
