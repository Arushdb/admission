...
<div class="contentDiv" align="center">
   <%@ page isELIgnored="false" %>
    ...
    <div style="font-weight:bold;color:red;"><c:out value="${exceptionSource}"/></div>
    Please <a href="<%= request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/account/getApplicantLoginScreen.htm" %>" class="actionLink" style="font-size:14px;">Click Here</a> to go to Login Page.
    </div>
