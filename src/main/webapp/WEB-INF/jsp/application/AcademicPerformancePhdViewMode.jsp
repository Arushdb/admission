...
<tr>
<td align="right">Published Papers</td><td align="left">${applicant.publishedPapers}</td><td align="right">Journal Description</td><td align="left">${applicant.journalDesc}</td>
</tr>
<tr>
<td align="right">Conferences</td><td align="left">${applicant.conferences}</td><td align="right">Conferences Description</td><td align="left">${applicant.conferencesDesc}</td>
</tr>
<tr>
<td align="right">Fellowship</td><td align="left">${applicant.fellowship}</td><td align="right">Fellowship Description</td><td align="left">${applicant.fellowshipDesc}</td>
</tr>
<tr>
<td align="right">RET Qualified</td><td align="left">${applicant.retQualified}</td><td align="right">RET Remarks</td><td align="left">${applicant.retRemarks}</td>
</tr>
<tr>
<td align="right">Year of RET Qualification</td><td align="left">${applicant.retYear}</td><td align="right">Roll Number</td><td align="left">${applicant.retRollNumber}</td>
</tr>
<tr>
<td align="right">Institute Teacher</td><td align="left">${applicant.instituteTeacher}</td><td align="right">JRF Qualified</td><td align="left">${applicant.jrfQualified}</td></tr>
<tr>
<td align="right">Recipient of Fellowship</td><td align="left">${applicant.deiScholor}</td><td align="right">DEI M.Phil. Scholor</td><td align="left">${applicant.deiMphil}</td>
</tr>
<tr>
<td align="right">Recipient Fellowship Type</td><td align="left" colspan="3">${applicant.recipientType}</td>
</tr>
<tr>
<td align="right">DEI Director Medal Winner</td><td align="left">${applicant.deiMedalWinner}</td><td align="right">DEI Post Graduate</td><td align="left">${applicant.deiPG}</td>
</tr>
<tr>
<td align="right">CGPA >= 9 in Post Graduation</td><td align="left" colspan="3">${applicant.cgpa9}</td>
</tr>
</table>
</td>
</tr>
