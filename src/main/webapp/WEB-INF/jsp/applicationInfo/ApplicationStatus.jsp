...
<html>
 ...
 <table>
 <tr align="left">
 <th>Application Number</th><th>Application Status</th>
 </tr>
 <c:forEach var="application" items="${appsStatusList}">
 <tr>
 <td><c:out value="${application.code}"/></td><td><c:out value="${application.description}"/></td>
 </tr>
 </c:forEach>
 <tr>
