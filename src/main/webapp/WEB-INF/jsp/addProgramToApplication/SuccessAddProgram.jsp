...
<div class="panelHeader"><div class="panelTitle">Programs added successfully to your application</div></div>
<div class="panelContent" align="center" style="padding-left: 20px;padding-right: 20px;">
	...
	<label style="font-family:verdana;font-size:12px;color:green;">${requestScope.error}</label>
	<table style="text-align: right;width:80%;" cellspacing="8">
	<form method="post" action="<%=response.encodeURL(request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/account/getApplicantLoginScreen.htm")%>">
	<tr>
    	<td  align="center"><input type="submit" value="Back to Home Page" class="customButton"/></td>
    </tr>
	</form>		
	<tr>
	</table>
