...
public class SelectDigitHandler extends SimpleTagSupport implements DynamicAttributes{
	private String name;
	...
	public void doTag() throws JspException, IOException
	{
		...
		for(int i =this.startIndex; i<= this.endIndex ; i++)
		{
			...
			if(i==Integer.parseInt(this.selectedValue))
			{
				optionTag = String.format(SELECTED_OPTION_TEMPLATE,  i,i);
			}
			else
			{
				optionTag = String.format(OPTION_TEMPLATE, i,i);
			}
